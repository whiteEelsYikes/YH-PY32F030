...
void OLED_GPIO_Init(void)
{
    ...
    I2cHandle.Mode                 = HAL_I2C_MODE_MASTER;       /* ����ģʽ */
    I2cHandle.Init.ClockSpeed      = I2C_SPEEDCLOCK;            /* I2CͨѶ�ٶ� */
    I2cHandle.Init.DutyCycle       = I2C_DUTYCYCLE;             /* I2Cռ�ձ� */
    I2cHandle.Init.OwnAddress1     = I2C_ADDRESS;               /* I2C��ַ */
    I2cHandle.Init.GeneralCallMode = I2C_GENERALCALL_DISABLE;   /* ��ֹ�㲥���� */
    I2cHandle.Init.NoStretchMode   = I2C_NOSTRETCH_DISABLE;     /* ����ʱ���ӳ� */
